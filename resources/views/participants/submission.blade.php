...
@if( count($questions) < 1) <p><strong>Nope!!</strong></p>
    @endif
            ...
            <div id="collapse{{ $question['question_id']}}" class="collapse">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="{{env('APP_URL') . $submissions[$question['question_id']] ['submitted_file'] }}" class="btn btn-success mr-1" target="_blank">Unduh Submisi</a>
