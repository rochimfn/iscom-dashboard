...
@section('title', 'Edit Persoalan')

@section('content_header')
    <h1>Edit Persoalan</h1>
    @include('component/validation')
@stop

@section('content')
    <form action="{{route('admin.competition.update.question.non-kti', $question['question_id'])}}" method="POST">
    @csrf
    @method('PUT')
        <div class="form-group">
            <label for="editTitle">Judul Persoalan</label>
