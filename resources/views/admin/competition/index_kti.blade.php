...
@section('title', 'Instruksi KTI')

@section('content_header')
    <div class="d-flex justify-content-between">
        <h1>Instruksi KTI</h1>
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addInstructionModal">
        Tambah Instruksi
        </button>
    </div>
...
@foreach($category as $item)
    ...
    @foreach($item['question'] as $question)
                ...
                <div class="d-flex justify-content-end">
                    <a class="btn btn-primary mr-1" href="{{route('admin.competition.edit.question.kti', $question['question_id'] )}}" >Edit</a>
                    <form action="{{ route('admin.competition.destroy.question.kti', $question['question_id']) }}" method="POST">
                        @csrf
                        @method('DELETE')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addInstructionLabel">Tambah instruksi</h5>
                ...
                <div class="modal-body">
                    ...
                    @csrf
                        ...
                        <div class="form-group">
                            <label for="instructionTitle">Judul Instruksi</label>
